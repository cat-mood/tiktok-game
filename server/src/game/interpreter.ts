import type { LogicEvent, Project, RuntimeFlags, TestCase, TestRun } from '@brainrot/shared'
import { defaultFlags, layoutForState, stateById } from '@brainrot/shared'
...
export function applyAction(
  ...
  if (!match) {
    return { stateId: currentStateId, flags }
  }
  ...
  return {
    stateId: nextId,
    flags: flagsForState(project, nextId, flags),
  }
}
